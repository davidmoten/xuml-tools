...
public class ExtensionsTest {
    ...
    public void testTypesAreGeneratedAsExpectedForEachMember() {
        ...
        try {
            ...
            A a = new A().setEmail_("fred@somewhere.com").setPostcode_(2601).persist(em);
        ...
        assertEquals(1, A.findByEmailPostcode("fred@somewhere.com", 2601).size());
        em = Context.createEntityManager();
        assertEquals(1, A.findByEmailPostcode(em, "fred@somewhere.com", 2601).size());
        em.close();
    }
