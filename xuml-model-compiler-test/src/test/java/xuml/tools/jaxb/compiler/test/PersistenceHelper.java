...
public class PersistenceHelper {
    ...
    public static EntityManagerFactory createEmf(String name, final String schema,
            DatabaseType type) {
        return Persistence.createEntityManagerFactory(name, getProperties(name, schema, type));
    }
    ...
    private static Map<String, String> getProperties(String name, String schema,
            DatabaseType type) {
        ...
        if (type == DatabaseType.DERBY) {
            ...
            String url = "jdbc:h2:mem:target/" + name + "-db;INIT=CREATE SCHEMA IF NOT EXISTS "
                    + schema;
            insertDatabaseSpecificProperties(map, dialect, driver, url);
    ...
    private static void createSchema(String url, String schema) {
        try {
            ...
            con.createStatement().execute("create schema " + schema + " authorization sa");
            con.close();
    ...
    private static void insertDatabaseSpecificProperties(Map<String, String> map, String dialect,
