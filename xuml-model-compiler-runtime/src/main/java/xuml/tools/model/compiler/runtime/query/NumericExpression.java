...
public abstract class NumericExpression<T extends Entity<T>> {
    ...
    public NumericExpression<T> plus(NumericExpression<T> e) {
        return new BinaryNumericExpression<T>(this, BinaryNumericOperator.PLUS, e);
    }
    ...
    public NumericExpression<T> minus(NumericExpression<T> e) {
        return new BinaryNumericExpression<T>(this, BinaryNumericOperator.MINUS, e);
    }

    public NumericExpression<T> minus(Number e) {
        return new BinaryNumericExpression<T>(this, BinaryNumericOperator.MINUS,
                new NumericConstant<T>(e));
    }

    public NumericExpression<T> times(NumericExpression<T> e) {
        return new BinaryNumericExpression<T>(this, BinaryNumericOperator.TIMES, e);
    }

    public NumericExpression<T> times(Number e) {
        return new BinaryNumericExpression<T>(this, BinaryNumericOperator.TIMES,
                new NumericConstant<T>(e));
    }

    public NumericExpression<T> divide(NumericExpression<T> e) {
        return new BinaryNumericExpression<T>(this, BinaryNumericOperator.DIVIDE, e);
    }

    public NumericExpression<T> divide(Number e) {
        return new BinaryNumericExpression<T>(this, BinaryNumericOperator.DIVIDE,
                new NumericConstant<T>(e));
    }
