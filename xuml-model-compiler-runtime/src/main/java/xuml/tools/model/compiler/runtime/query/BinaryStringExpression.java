...
public class BinaryStringExpression<T extends Entity<T>> extends StringExpression<T> {

    private final StringExpression<T> e1;
    private final StringExpression<T> e2;
    private final BinaryStringOperator op;

    public BinaryStringExpression(StringExpression<T> e1, BinaryStringOperator op,
