...
public abstract class DateExpression<T extends Entity<T>> {
	...
	public BooleanExpression<T> lt(Date e) {
		return new DateComparison<T>(this, DateComparisonOperator.LT,
				new DateConstant<T>(e));
	}

	public BooleanExpression<T> gt(Date e) {
		return new DateComparison<T>(this, DateComparisonOperator.GT,
				new DateConstant<T>(e));
	}
	...
	public BooleanExpression<T> lte(Date e) {
		return new DateComparison<T>(this, DateComparisonOperator.LTE,
				new DateConstant<T>(e));
	}

	public BooleanExpression<T> gte(Date e) {
		return new DateComparison<T>(this, DateComparisonOperator.GTE,
				new DateConstant<T>(e));
	}

	public BooleanExpression<T> eq(Date e) {
		return new DateComparison<T>(this, DateComparisonOperator.EQ,
				new DateConstant<T>(e));
	}

	public BooleanExpression<T> neq(Date e) {
		return new DateComparison<T>(this, DateComparisonOperator.NEQ,
				new DateConstant<T>(e));
	}
