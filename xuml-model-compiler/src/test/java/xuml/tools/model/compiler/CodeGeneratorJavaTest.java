...
public class CodeGeneratorJavaTest {
    ...
    @Test
    public void testCodeGenerationForOneToOneMany() throws FileNotFoundException {
        generateClassesForDomain("one-to-one-many");
    }

    @Test
    public void testCodeGenerationForOneToZeroOne() throws FileNotFoundException {
        generateClassesForDomain("one-to-zero-one");
    }

    @Test
    public void testCodeGenerationForSecondaryIdentifiers() throws FileNotFoundException {
        generateClassesForDomain("secondary-identifiers");
    }

    @Test
    public void testCodeGenerationForSpecialization() throws FileNotFoundException {
    ...
    @Test
    public void testCodeGenerationForUnaryToZeroOne() throws FileNotFoundException {
    ...
    @Test
    public void testCodeGenerationForUnaryToOneMany() throws FileNotFoundException {
        generateClassesForDomain("unary-one-many");
    }

    @Test
    public void testCodeGenerationForZeroOneToMany() throws FileNotFoundException {
        generateClassesForDomain("zero-one-to-many");
    }

    @Test
    public void testCodeGenerationForZeroOneToOneMany() throws FileNotFoundException {
    ...
    @Test
    public void testCodeGenerationForManyToManyWithAssociationClass() throws FileNotFoundException {
    ...
    // @Test
    public void testCodeGenerationForAirTrafficControllerSample() throws FileNotFoundException {
    ...
    private void generateClassesForDomain(String domainName, String domainPackageName,
            String schema, String xmlPath) {
        ...
        new CodeGeneratorJava(domains, domainName, domainPackageName, schema, entitySourceDirectory,
                resourcesDirectory, implementationPackageName, implementationSourceDirectory, true,
                true).generate();
    ...
    private void generateClassesForDomain(String domainName, String domainPackageName,
            String schema) {
        generateClassesForDomain(domainName, domainPackageName, schema, "/samples.xml");
    }
}
