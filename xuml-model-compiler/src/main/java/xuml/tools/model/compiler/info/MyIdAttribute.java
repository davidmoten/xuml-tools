...
public class MyIdAttribute {
    ...
    public MyIdAttribute(String attributeName, String fieldName, String columnName,
            String referenceClass, String referenceColumnName, MyTypeDefinition type,
    ...
    public MyIdAttribute(String attributeName, String fieldName, String columnName,
            MyTypeDefinition type, MyAttributeExtensions extensions) {
