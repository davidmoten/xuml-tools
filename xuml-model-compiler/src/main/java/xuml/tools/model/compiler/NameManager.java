...
public class NameManager {
    ...
    public NameManager() {
        try {
            ...
            // 10.2
            InputStream in = NameManager.class.getResourceAsStream("/database-reserved-words.txt");
    ...
    public String toFieldName(String cls, String viewedClass, BigInteger rNum) {
        ...
        if (map.get(key) != null)
            ...
            String optimalFieldName = Util.lowerFirst(Util.toJavaIdentifier(viewedClass)) + "_R"
                    + rNum;
